...
RESEARCH_TOOL_PROXY_URL = os.getenv("RESEARCH_TOOL_PROXY_URL", "")
RESEARCH_TOOL_API_KEY = os.getenv("RESEARCH_TOOL_API_KEY", "")
RESEARCH_TOOL_AGENT_ID = os.getenv("RESEARCH_TOOL_AGENT_ID", "")
RESEARCH_TOOL_TIMEOUT_SECONDS = int(os.getenv("RESEARCH_TOOL_TIMEOUT_SECONDS", "120"))
