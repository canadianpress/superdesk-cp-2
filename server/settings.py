...
ARCHIVE_SEARCH_API_BASE_URL = os.getenv("ARCHIVE_SEARCH_API_BASE_URL", "http://localhost:8080")
ARCHIVE_SEARCH_API_SEARCH_PATH = os.getenv("ARCHIVE_SEARCH_API_SEARCH_PATH", "/v1/archive/search")
ARCHIVE_SEARCH_API_KEY = os.getenv("ARCHIVE_SEARCH_API_KEY", "")
ARCHIVE_SEARCH_API_TIMEOUT_SECONDS = int(os.getenv("ARCHIVE_SEARCH_API_TIMEOUT_SECONDS", "15"))
...
ARCHIVE_SEARCH_DEFAULT_RECENT_DAYS = int(os.getenv("ARCHIVE_SEARCH_DEFAULT_RECENT_DAYS", "30"))
